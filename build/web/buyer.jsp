...
<%
    try{
        ...
        String sql = " SELECT MAX(RIGHT(kode, 4)) FROM buyer";
        ...
        if(res.next()) {
            if(res.getString(1) != null) {
                ...
                request.setAttribute("KODE", "B0001");
            }
        }
        res.close();
        st.close();
    ...
    if(request.getParameterMap().containsKey("cmdCari") == true) {
        ...
        if(dapat.toString().equals("Cari")) {
            try{
                ...
                Connection conn = konek.bukaKoneksi();
                Statement st=conn.createStatement();
                String sql = "SELECT * FROM buyer WHERE nama='"+nama+"'";
                ResultSet res  = st.executeQuery(sql);
                if(res.next()) {
                ...
                <div class="col-lg-8">
                    <form name="formBarang" class="col-md-12" action="" method="POST">
                        ...
                        <div class="form-group row ">
                            <label class="col-sm-2 col-form-label">Kode Buyer</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row ">
                            <label class="col-sm-2 col-form-label">Nama Buyer</label>
                            <div class="col-sm-5">
    ...
    if(request.getParameterMap().containsKey("cmdSimpan") == true) {
        ...
        if(dapat.toString().equals("Simpan")) {
            try{
                ...
                Connection conn = konek.bukaKoneksi();
                Statement st=conn.createStatement();
                String sql = "INSERT INTO buyer(kode, nama, alamat, noHp, email, kontak, noRek, bank, keterangan)"
...
//                        + " VALUES('B0001', 'SHF S.H.Figuarts Kamen Rider Genm Zombie Action Gamer Level X-0', 'dsadasd', 'PVC Figure', '10', 'Box', '1320000', '1420000', '100000')";
        ...
        if(dapat.toString().equals("Ubah")) {
            try{
                ...
                Connection conn = konek.bukaKoneksi();
                Statement st=conn.createStatement();
                String sql = "UPDATE buyer SET kode = '"+kode+"', nama = '"+nama+"', alamat = '"+alamat+"', "
